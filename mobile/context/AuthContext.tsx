    ...
    try {
      ...
      try {
        if (typeof window !== 'undefined' && window.localStorage) {
          ...
          console.log('[AuthContext] checkInitialAuthState: adminToken from localStorage:', at ? `${at.substring(0, 20)}...` : 'NULL');
          if (t) setSupabaseAccessToken(t);
          if (at) {
            console.log('[AuthContext] Setting adminToken from localStorage');
            setAdminToken(at);
